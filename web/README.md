...
No Docker o nginx serve o `dist/` e faz proxy de `/api` — ver `docker-compose.yml` na raiz.
...
A paleta sai do PNG do logo (`#11426b` azul, `#00aea9` teal, `#73777c` cinza) —
os valores foram amostrados do arquivo, não estimados.
