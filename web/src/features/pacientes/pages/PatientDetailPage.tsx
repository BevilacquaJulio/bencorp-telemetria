  ...
  return (
    <div className="page-stack">
      ...
      <section className="history-section page-enter page-enter--1">
        ...
        {patient.data.atendimentos.length === 0 ? (
          <EmptyState
                ...
                <div className="care-entry__content">
                  ...
                  {attendance.triagem ? (
                    <div className="clinical-summary">
                      <div className="clinical-summary__heading">
                        <div className="clinical-summary__title">
                          <HeartbeatIcon size={20} weight="duotone" />
                          <div>
                            <strong>Dados da triagem</strong>
                            <span>{attendance.triagem.queixa}</span>
                          </div>
                        </div>
                        <div className="clinical-summary__meta">
                  ...
                  {attendance.prontuario ? (
                    <div className="medical-record">
                      <div className="medical-record__heading">
                        ...
                        <div>
                          ...
                          <span>
                            Registrado por {attendance.prontuario.autor.nome}
                          </span>
                        </div>
                      </div>
                    ...
                    <p className="care-entry__note">
                      ...
                      {attendance.prontuario === undefined
